...
while True:
    ...
    if robot.node in range(5,11) or robot.node in range(16,21):
        box = robot.leftDistance.determine_if_box(n_samples=3) #need to tune this according to how much time we have to see boxes (esp start and end box)
        if box:
